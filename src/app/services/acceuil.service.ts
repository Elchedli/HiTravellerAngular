...
export class AcceuilService {
  ...
  public afficherpartner() {
    return this.http.post<any>("http://localhost:8083/voyageAffaires/acceuil/listPartenaires", {});
  }
  public ajouterpartner(jsonData: Object) {
    return this.http.post<any>("http://localhost:8083/voyageAffaires/acceuil/ajouterPartner",jsonData,{responseType:'text' as 'json'});
  }

  public effacerpart(name:string) {
    return this.http.get("http://localhost:8083/voyageAffaires/acceuil/DeletePartner/"+name,{responseType:'text' as 'json'});
  }
  ...
  public recomajouter(dataJson:object){
    return this.http.post("http://localhost:8083/voyageAffaires/acceuil/ajouterRecom",dataJson,{responseType:'text' as 'json'});
  }
  public recomafficher(dataJson:object){
    return this.http.post("http://localhost:8083/voyageAffaires/acceuil/listRecomAvis/",dataJson);
  }
  public recomAll(categorie:string){
    return this.http.get("http://localhost:8083/voyageAffaires/acceuil/listRecom/"+categorie);
  }
