...
(function (e) {
  ...
  e.extend(l.prototype, {
    ...
    add: function (a, b) {
      ...
      if ("string" === typeof b) {
        for (
          var d = b.split("-"), c = this.s, e = 0, h = d.length - 1;
          e < h;
          e++
        )
          c = c.buttons[1 * d[e]];
        ...
        f && "absolute" === g
          ...
          ? (d._collection.css({ top: a.top + c.outerHeight(), left: a.left }),
            ...
            d._collection.hasClass(d.rightAlignClassName) &&
              d._collection.css(
                "left",
                a.left + c.outerWidth() - d._collection.outerWidth()
              ),
            ...
            c > e(n).width() &&
              d._collection.css("left", a.left - (c - e(n).width())))
